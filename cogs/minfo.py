...
class MemberInfo(commands.Cog):
    ...
    def __init__(self, bot):
        self.bot = bot
        self.mod_roles: dict[int, discord.Role | None] = {}  # per-guild mod role
    ...
    async def get_or_ask_mod_role(self, ctx):
        ...
        return self.mod_roles.get(guild_id)
